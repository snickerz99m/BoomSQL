...
from .advanced_tester_page import AdvancedTesterPage
...
class MainWindow:
    ...
    def __init__(self, root: tk.Tk, app):
        ...
        self.advanced_tester_page = None
    ...
    def create_tabs(self):
        ...
        # Advanced SQL Tester Tab
        self.advanced_tester_page = AdvancedTesterPage(self.notebook, self.app)
        self.notebook.add(self.advanced_tester_page, text=safe_text("🚀 Advanced Tester"))
        
        # Database Dumper Tab
        self.dumper_page = DumperPage(self.notebook, self.app)
        self.notebook.add(self.dumper_page, text=safe_text("💾 Database Dumper"))
        
        # Database Tree View Tab
        from .database_tree_view import DatabaseTreeView
        self.database_tree_frame = ttk.Frame(self.notebook)
        self.database_tree = DatabaseTreeView(self.database_tree_frame)
        self.notebook.add(self.database_tree_frame, text=safe_text("🌳 Database Tree"))
