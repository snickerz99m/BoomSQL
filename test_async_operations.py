...
def test_async_sql_engine():
    ...
    try:
        ...
        # Run async operation
        result = manager.run_async_blocking(test_url(), timeout=10.0)
...
def test_async_web_crawler():
    ...
    try:
        ...
        # Run async operation
        result = manager.run_async_blocking(test_crawl(), timeout=10.0)
...
def test_async_dork_searcher():
    ...
    try:
        ...
        # Run async operation
        result = manager.run_async_blocking(test_search(), timeout=10.0)
...
def test_gui_async_integration():
    ...
    try:
        ...
        def simulate_gui_operation():
            ...
            # Run the async operation from GUI context
            results = manager.run_async_blocking(gui_async_task(), timeout=20.0)
            return results
